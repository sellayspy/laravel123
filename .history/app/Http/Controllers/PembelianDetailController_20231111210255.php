...
class PembelianDetailController extends Controller
{
    ...
    public function data($id)
    {
      ...
      foreach ($detail as $key => $item) {
        ...
        $row ['jumlah'] = '<input type="number" class="form-control input-sm quantity" data-id="'. $item->id_pembelian_detail .'" name="jumlah_'. $detail->id_pembelian_detail.'" value="'. $detail->jumlah .'">';
