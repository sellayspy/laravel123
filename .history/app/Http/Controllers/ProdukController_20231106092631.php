...
class ProdukController extends Controller
{
    ...
    public function data()
    {
     ...
     ->get();
       ...
       /*->addColumn('select_all',function($produk){
        return '
        <input type="checkbox" id="id_produk[]" value="'. $produk->id_produk .'">
        ';
       })*/
       ...
       ->rawColumns(['aksi','kodeProduk','select_all'])
       ->make(true);
    }
    /**
    ...
    public function store(Request $request)
    {
        ...
        $request['kodeProduk'] = 'P'. tambah_nol_didepan((int)$produk->id_produk, 6);
