...
class PembelianController extends Controller
{
    ...
    public function show($id)
    {
        ...
        ->of($detail)
        ->addIndexColumn()
        ->addColumn('totalItem',function($detail){
         return format_uang($detail->totalItem);
        })
        ->addColumn('totalHarga',function($detail){
         return 'Rp.'. format_uang($detail->totalHarga);
        })
        ...
        ->addColumn('supplier', function($detail){
         return $detail->suplier->namaSuplier;
        })
        ->make(true);
    }
