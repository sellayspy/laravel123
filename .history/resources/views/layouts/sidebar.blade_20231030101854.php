<ul
      ...
      >
        ...
        >
          ...
          <div class="sidebar-brand-text mx-3">Test Projeck <sup>1</sup></div>
        </a>
        ...
        <li class="nav-item">
          ...
          >
            <div class="bg-white py-2 collapse-inner rounded">
              <a class="collapse-item" href="{{ route('barangs.index') }}">Data Barang</a>
              <a class="collapse-item" href="{{ route('customers.index') }}">Data Customer</a>
              <a class="collapse-item" href="{{ route('supliers.index') }}">Data Suplier</a>
            </div>
          </div>
        </li>
