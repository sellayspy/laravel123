                ...
                <div class="row">
                    ...
                    <div class="col-lg-4">
                        <form action="{{ route('transaksi.store') }}" class="form-penjualan" method="post">
                            ...
                            <div class="form-group row">
                                <label for="namaCustomer" class="col-lg-2 control-label">Customer</label>
                                <div class="col-lg-8">
                                <div class="input-group">
...
//Fungsi Untuk form Kembalian                                                                         BACOTYYYYYYYYYYYYYYYYYYYYYYYYYYYY
...
//Tampil Customer
        ...
        // Fungsi Untuk Mengapus Barang Yang Di Pilih
