    ...
    <div class="col-md-12">
        <div class="box">
            <div class="box-header with-border">
                ...
                <button onclick="deleteSelected('{{ route('produk.delete_selected') }}')" class="btn btn-danger xs btn-flat"><i class="fa fa-plus-trash"></i>Tambah</button>
                </div>
            </div>
            <div class="box-body table-responsive">
               <form action="" class="from-produk">
                @csrf
        ...
        function editForm(url) {
           ...
           $('#modal-form form').attr('action',url);
            ...
            .done((response) => {
                ...
                $('#modal-form [name=hargaSatuan]').val(response.hargaSatuan);
