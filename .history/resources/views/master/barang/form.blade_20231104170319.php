    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
        <div class="form-group row">
            <label for="namaBarang" class="col-md-2 col-md-offset-1 control-label">Barang</label>
            <div class="col-md-9">
            <input type="text" name="nmBarang" id="namaBarang" class="form-control" required autofocus>
      ...
      <!--  <div class="form-group row">
        ...
        <div class="form-group row">
            ...
            <div class="col-md-9">
            <input type="date" name="tglExpired" id="tglExpired" class="form-control" required>
            <span class="help-block with-errors"></span>
            </div>
