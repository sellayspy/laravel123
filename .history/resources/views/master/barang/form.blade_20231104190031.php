    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
        ...
        <div class="form-group row">
            ...
            <div class="col-md-9">
            <input type="number" name="hargaSatuan" id="hargaSatuan" class="form-control">
            <span class="help-block with-errors"></span>
            </div>

        </div>
        <div class="form-group row">
            <label for="stok" class="col-md-2 col-md-offset-1 control-label">Harga Satuan</label>
            <div class="col-md-9">
        ...
        <div class="form-group row">
            <label for="tglExpired" class="col-md-2 col-md-offset-1 control-label">Harga Satuan</label>
            <div class="col-md-9">
            <input type="number" name="tglExpired" id="tglExpired" class="form-control">
            <span class="help-block with-errors"></span>
            </div>
