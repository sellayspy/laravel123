   ...
   <form action="" method="post" class="form-horizontal">
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
        ...
        <div class="form-group row">
            <label for="hargaJual" class="col-md-2 col-md-offset-1 control-label">Harga Satuan</label>
            <div class="col-md-9">
            <input type="number" name="hargaJual" id="hargaJual" class="form-control" required>
            <span class="help-block with-errors"></span>
            </div>

        </div>
        <div class="form-group row">
            <label for="hargaBeli" class="col-md-2 col-md-offset-1 control-label">Harga Beli</label>
            <div class="col-md-9">
