    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
        <div class="form-group row">
            <label for="namaCustomer" class="col-md-2 col-md-offset-1 control-label">Nama</label>
            <div class="col-md-9">
            <input type="text" name="namaCustomer" id="namaCustomer" class="form-control" required autofocus>
        ...
        <div class="form-group row">
            ...
            <div class="col-md-9">
            <input type="text" name="noTelepon" id="noTelepon" class="form-control" required autofocus>
            <span class="help-block with-errors"></span>
            </div>
