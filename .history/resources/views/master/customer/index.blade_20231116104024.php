...
<div class="row">
    <div class="col-md-12">
        <div class="box">
            ...
            <button onclick="deleteSelected('{{ route('customer.delete_selected') }}')" class="btn btn-danger xs btn-flat"><i class="fa fa-trash"></i>Hapus</button>
            <button onclick="cetakMember('{{ route('customer.member') }}')" class="btn btn-info xs btn-flat"><i class="fa fa-id-card"></i>Cetak Kartu</button>
            </div>
