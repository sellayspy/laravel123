...
Route::group(['middleware'=> 'auth'],function(){
    ...
    Route::get('/transaksi/baru', [PenjualanDetailController::class,'create'])->name('transaksi.baru');
    Route::resource('/transaksi', PenjualanDetailController::class)->except('show');
    Route::get('/transaksi/{id}/data',[PenjualanController::class,'data'])->name('transaksi.data');
});
